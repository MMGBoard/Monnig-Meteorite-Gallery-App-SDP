...
export default function DisplayScreen({navigation} : {navigation: any}) { //Add Params for passing card
        ...
        <View>
            ...
            <View style={styles.container}>
                <PaperSurface  style={styles.surface}>
                    ...
                    <PaperDivider/>
                        <PaperText style={styles.label}>Meteorite Name</PaperText>
                        <PaperText style={styles.year}>Meteorite Year</PaperText>
                        <PaperText style={styles.description}>Meteorite Description</PaperText>
                    </View>
                </PaperSurface>
